...
<div class="sub-total flex items-center justify-between lg:w-10/12 xl:9/12 mx-auto">
    ...
    <h1 class="font-bold text-xl text-blue-500">$ 153.50</h1>
</div>
...
<p class="text-blue-500 font-semibold text-lg px-6">( 4 items )</p>
...
<perfect-scrollbar>
  ...
  <div class="cart-item mt-4 mx-6 p-4 rounded-xl" >
     <div class="cart-item-main">

     <div class="left cart-item-grid">
<!-- "w-20 lg:w-28 xl:w-34 xl:w-34  -->
    <div class="cart-item-image">
        <img src="~/assets/images/product-main.png" class="border w-full  border-gray-500 rounded-md" alt="">
    </div>
    <div class="cart-item-details ltr:ml-4 rtl:mr-4 my-1 flex flex-col justify-between">
        <h3 class="name font-bold text-lg">Cashew Extra</h3>
...
<path d="M9 5H5M5 5H1M5 5V1M5 5V9" stroke="#F2994A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
     ...
     <div class="delete-btn flex flex-col items-end justify-between justify-self-end">
       ...
       <button class="bg-red-500 focus:outline-none h-10 flex justify-center items-center w-10 rounded-full shadow-xl">
...
<p class="text-green-500 font-bold text-2xl">$ 7.00</p>
    </div>
         </div>
